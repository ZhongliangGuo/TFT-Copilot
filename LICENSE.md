...
Required Notice: Copyright TFT Copilot contributors
...
the software according to [Distribution
...
new works permitted by [Changes and New Works
...
Noncommercial use (personal, hobby, research, education, etc.) is free under
the terms above. If you want to use this project or the distributed ONNX
models for a commercial purpose, please reach out first to arrange a license:

**guo_zhongliang@hotmail.com**
